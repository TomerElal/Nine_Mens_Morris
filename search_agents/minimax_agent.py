...
class MiniMaxAgent(Agent):
    ...
    def get_action(self, game_state):
        ...
        def minimax_algorithm(curr_agent, curr_game_state, depth):
            ...
            if curr_agent == AgentType.MAX:
                ...
                for player_action in curr_game_state.get_legal_actions(player_number=1):
                    ...
                    score = minimax_algorithm(next_agent, new_state_successor, depth)[0]
                    if score > max_val:
                        max_val = score
        ...
        if game_state.move_type == MoveType.REMOVE_OPPONENT_PIECE:
            start_depth = 1
        return minimax_algorithm(AgentType.MAX, game_state, start_depth)[1]
